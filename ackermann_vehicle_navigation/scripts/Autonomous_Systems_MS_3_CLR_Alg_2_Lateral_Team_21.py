...
# This is added to give time for other programs to start before starting this node
time.sleep(5)
...
def odometry_callback(data):
    ...
    real_position = data.pose.pose
    real_speed = data.twist.twist
...
sub1 = rospy.Subscriber('/odom', Odometry, odometry_callback)
